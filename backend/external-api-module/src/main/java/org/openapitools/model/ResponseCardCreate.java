...
public class ResponseCardCreate implements ContentV1CardsMoveNmPost400Response {
  ...
  private ResponseCardCreateAdditionalErrors additionalErrors;

  public ResponseCardCreate data(Object data) {
  ...
  */
  ...
  public ResponseCardCreate error(Boolean error) {
    this.error = error;
    return this;
  }
  ...
  */
  ...
  public ResponseCardCreate errorText(String errorText) {
  ...
  */
  ...
  public ResponseCardCreate additionalErrors(ResponseCardCreateAdditionalErrors additionalErrors) {
  ...
  */
  ...
  public void setAdditionalErrors(ResponseCardCreateAdditionalErrors additionalErrors) {
    this.additionalErrors = additionalErrors;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResponseCardCreate responseCardCreate = (ResponseCardCreate) o;
    return Objects.equals(this.data, responseCardCreate.data) &&
        Objects.equals(this.error, responseCardCreate.error) &&
        Objects.equals(this.errorText, responseCardCreate.errorText) &&
        Objects.equals(this.additionalErrors, responseCardCreate.additionalErrors);
  }
