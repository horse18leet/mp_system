...
//    @GetMapping("/orders")
    ...
    private void getIntervalOrders(@RequestBody MessageOrderReceiveDTO message) throws URISyntaxException, IOException {
        ...
        try {
            orders = restTemplate.exchange(getOrdersUrl, HttpMethod.GET, entity, MessageOrderSendDTO.class).getBody();
        ...
        rabbitTemplate.convertAndSend(directExchange.getName(), "event_get_orders", orders);
    }
}
