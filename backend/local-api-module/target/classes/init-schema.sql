...
ALTER TABLE costs
    ADD CONSTRAINT FK_COSTS_ON_ID_PURCHASE FOREIGN KEY (id_purchase) REFERENCES users (id);

ALTER TABLE items
    ADD CONSTRAINT FK_ITEMS_ON_ID_ITEM FOREIGN KEY (id_item) REFERENCES items (id);
...
ALTER TABLE purchase_items
    ADD CONSTRAINT FK_PURCHASE_ITEMS_ON_ID_PURCHASE FOREIGN KEY (id_purchase) REFERENCES users (id);
